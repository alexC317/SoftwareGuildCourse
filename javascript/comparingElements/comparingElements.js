...
// Also nore that JavaScript is loosely typed - which means it allows us to mix types in our array...
// And that can cause all sorts of confusion.
// Mixing element types like this is a *bad* practice.
// We are dong this to show you how JavaScript can do these and how JavaScript can treat strings like numbers
...
for (var arrayPosition = 0; arrayPosition < testArray.length-1; arrayPosition++)
{
  ...
  if (currentElement == nextElement)
  {
    ...
    if(currentElement !== nextElement)
    {
      // We can use the typeof() function of JavaScript to identify the type of an elements
